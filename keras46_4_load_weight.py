...
# model.save('./_save/keras46_1_model_1.h5')
# model.save_weights('./_save/keras46_1_weight_1.h5')

# model = load_model('./_save/keras46_1_model_1.h5')
# model = load_model('./_save/keras46_1_model_2.h5')
# model = load_model('./_save/keras46_1_weights_1.h5')
# model = load_model('./_save/keras46_1_weight_2.h5')
model.summary()
...
# model.load_weights('./_save/keras46_1_weight_1.h5')
model.load_weights('./_save/keras46_1_weight_2.h5') # 제대로 된 weight를 불러온다.
...
# model.save('./_save/keras46_1_model_2.h5')
# model.save_weights('./_save/keras46_1_weights_2.h5')
#4. 평가, 예측
# mse, R2
