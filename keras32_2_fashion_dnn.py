...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, MaxPooling2D, GlobalAveragePooling1D
...
start = time.time()
model.fit(x_train, y_train, epochs=500, batch_size=500, validation_split=0.05, callbacks=[es])
