...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, MaxPooling2D, Dropout, LSTM, Conv1D
...
model = Sequential()
model.add(Conv1D(128, 4, activation='relu', input_shape=(32*32, 3)))
...
# kernel size 1-> 4 조절, Conv1d의 filters 조절 
# accuracy :  0.10000000149011612 -> accuracy :  0.539900004863739 -> accuracy :  0.5645999908447266