...
from tensorflow.keras.layers import Dense, GlobalAveragePooling2D, Conv2D, Flatten, LSTM, Conv1D
...
model.add(Conv1D(filters=32, kernel_size=1, activation='relu', input_shape=(13, 1)))
