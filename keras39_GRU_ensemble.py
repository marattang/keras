...
dense1 = GRU(units=32, activation='relu', input_shape=(3, 1))(input1)
dense2 = Dense(32, activation='relu')(dense1)
dense3 = Dense(16, activation='relu')(dense2)
dense4 = Dense(16, activation='relu')(dense3)

input11 = Input(shape=(3,1))
dense11 = GRU(units=32, activation='relu', input_shape=(3, 1))(input11)
...
model.fit([x1,x2], y, batch_size=1, epochs=50) 
