...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, MaxPooling2D, GlobalAveragePooling1D, LSTM, Conv1D
...
model.add(Conv1D(16, input_shape=(28 * 28, 1), activation='relu', kernel_size=1))
